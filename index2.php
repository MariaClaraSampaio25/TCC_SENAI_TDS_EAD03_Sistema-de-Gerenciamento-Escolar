...
<body>
    <header class="cabecalho">
        <div style="display: flex; align-items: center;">
            <a class="cabecalho-inicio" href="http://localhost/APPGestao_Escolar/index2.php" style='text-decoration: none;'>&nbsp;&nbsp; <svg
                    xmlns="http://www.w3.org/2000/svg" width="30" height="30" fill="white" class="bi bi-house-fill"
                    viewBox="0 0 16 16">
                    <path
        ...
        <ul class="lista-cabecalho">
            ...
            <li>
                <?php echo "<a href='sair.php' style='text-decoration: none;'><svg xmlns='http://www.w3.org/2000/svg' width='25' height='25' fill='white' class='bi bi-power' viewBox='0 0 16 16'>
            <path d='M7.5 1v7h1V1z' />
            <path d='M3 8.812a5 5 0 0 1 2.578-4.375l-.485-.874A6 6 0 1 0 11 3.616l-.501.865A5 5 0 1 1 3 8.812' />
        </svg></a>&nbsp;&nbsp;<a href='sair.php' style='text-decoration: none;'><font color='white'><b>Sair</b></font></a>"; ?>
            </li>
